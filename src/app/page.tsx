...
export const metadata: Metadata = {
  ...
  description:
    'Play Clicker, a fun, chaotic 3D Roblox-style heist game that features many Brainrot meme characters. Buy and steal to fill your base with the best Brainrots! No installs needed—play instantly on any device with Clicker Games.',
  keywords: [
    'free online games',
    'browser games',
    'IO games',
